...
b) Construcción de Openbravo (en Debian Linux)
...
c) Configurar con el diálogo anterior las propiedades de OpenBravo
...
d) Crear BBDD con el nombre del administrador de la BBDD (si no falla el script de setup de OpenBravo)

> createdb -U sa -h localhost sa

e) Editar el fichero <.>/erp/config/Openbravo.properties y añadir las propiedades o modificarlas:
...
f) Construcción openbravo desde el directorio actual

> cd erp
> ant install.source

g) Despliegue de war en tomcat
